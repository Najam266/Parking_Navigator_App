...
namespace APP
{
    public partial class Leavepark : Form
    {
        ...
        private void check_park()
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(connectionstring))
            {
                ...
                string checkQuery = "SELECT Car_Type FROM Parking WHERE Name = @name AND Registration_No = @Reg";
        ...
        private void Leavepark_Load(object sender, EventArgs e)
        {
            showtable();
        }
